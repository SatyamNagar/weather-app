    ...
    return (
        <div className='loader-body'>
            <div className="preloader" style={{opacity: 1}}>
                <svg className='loader-svg' version="1.1" id="sun" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enableBackground="new 0 0 10 10" space="preserve" style={{ opacity: 1, marginLeft: '0px', marginTop: '0px' }} >
                    <g>
                ...
                <svg className='loader-svg' version="1.1" id="cloud" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enableBackground="new 0 0 10 10" space="preserve">
